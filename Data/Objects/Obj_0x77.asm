...
; Offset_0x023CC4:
                ...
                move.w  Offset_0x023CD2(PC, D0), D1
                jmp     Offset_0x023CD2(PC, D1)       
;-------------------------------------------------------------------------------  
Offset_0x023CD2:
                dc.w    Offset_0x023CD6-Offset_0x023CD2
                dc.w    Offset_0x023CF8-Offset_0x023CD2       
;-------------------------------------------------------------------------------   
Offset_0x023CD6:
                addq.b  #$02, Obj_Routine(A0)                            ; $0024
                move.l  #DHz_Bridge_Mappings, Obj_Map(A0) ; Offset_0x023DA0, $0004
                move.w  #$643C, Obj_Art_VRAM(A0)                         ; $0002
                bsr     Jmp_21_To_ModifySpriteAttr_2P          ; Offset_0x023EFA
                ori.b   #$04, Obj_Flags(A0)                              ; $0001
                move.b  #$80, Obj_Width(A0)                              ; $0019  
;-------------------------------------------------------------------------------  
Offset_0x023CF8:
                tst.b   Obj_Control_Var_08(A0)                           ; $0034
                bne.s   Offset_0x023D2C
                lea     ($FFFFF7E0).w, A2
                moveq   #$00, D0
                move.b  Obj_Subtype(A0), D0                              ; $0028
                btst    #$00, $00(A2, D0)
                beq.s   Offset_0x023D2C
                move.b  #$01, Obj_Control_Var_08(A0)                     ; $0034
                bchg    #00, Obj_Ani_Number(A0)                          ; $001C
                tst.b   Obj_Flags(A0)                                    ; $0001
                bpl.s   Offset_0x023D2C
                move.w  #$00BB, D0
                jsr     (Play_Sfx)                             ; Offset_0x001912
Offset_0x023D2C:
                lea     (DHz_Bridge_Animate_Data), A1          ; Offset_0x023D8C
                jsr     (AnimateSprite)                        ; Offset_0x01212E
                tst.b   Obj_Map_Id(A0)                                   ; $001A
                bne.s   Offset_0x023D56
                move.w  #$004B, D1
                move.w  #$0008, D2
                move.w  D2, D3
                addq.w  #$01, D3
                move.w  Obj_X(A0), D4                                    ; $0008
                bsr     Jmp_11_To_SolidObject                  ; Offset_0x023F00
                bra     Jmp_15_To_MarkObjGone                  ; Offset_0x023EF4
Offset_0x023D56:
                move.b  Obj_Status(A0), D0                               ; $0022
                andi.b  #$18, D0
                beq.s   Offset_0x023D88
                move.b  D0, D1
                andi.b  #$08, D0
                beq.s   Offset_0x023D72
                lea     (Obj_Memory_Address).w, A1                   ; $FFFFB000
                bclr    #$03, Obj_Status(A1)                             ; $0022
Offset_0x023D72:
                andi.b  #$10, D1
                beq.s   Offset_0x023D82
...
Offset_0x023D88:
                bra     Jmp_15_To_MarkObjGone                  ; Offset_0x023EF4       
;-------------------------------------------------------------------------------    
DHz_Bridge_Animate_Data:                                       ; Offset_0x023D8C
                dc.w    Offset_0x023D90-DHz_Bridge_Animate_Data
                dc.w    Offset_0x023D98-DHz_Bridge_Animate_Data
Offset_0x023D90:
                dc.b    $03, $04, $03, $02, $01, $00, $FE, $01
Offset_0x023D98:
                dc.b    $03, $00, $01, $02, $03, $04, $FE, $01    
;-------------------------------------------------------------------------------
DHz_Bridge_Mappings:                                           ; Offset_0x023DA0
                dc.w    Offset_0x023DAA-DHz_Bridge_Mappings
                dc.w    Offset_0x023DEC-DHz_Bridge_Mappings
                dc.w    Offset_0x023E2E-DHz_Bridge_Mappings
                dc.w    Offset_0x023E70-DHz_Bridge_Mappings
                dc.w    Offset_0x023EB2-DHz_Bridge_Mappings
Offset_0x023DAA:
                dc.w    $0008
