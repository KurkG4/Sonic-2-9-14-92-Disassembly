...
; Offset_0x023710:
                ...
                move.w  Offset_0x02371E(PC, D0), D1
                jmp     Offset_0x02371E(PC, D1)
;-------------------------------------------------------------------------------   
Offset_0x02371E:
                dc.w    Offset_0x023724-Offset_0x02371E
                dc.w    Offset_0x023812-Offset_0x02371E
                dc.w    Offset_0x0238BA-Offset_0x02371E        
;-------------------------------------------------------------------------------    
Offset_0x023724:
                addq.b  #$02, Obj_Routine(A0)                            ; $0024
                move.l  #Rotating_Rings_Mappings, Obj_Map(A0) ; Offset_0x0238D8, $0004
                move.w  #$26BC, Obj_Art_VRAM(A0)                         ; $0002
                bsr     Jmp_1E_To_ModifySpriteAttr_2P          ; Offset_0x0238F6
                ...
                subq.w  #$01, D1
                bcs.s   Offset_0x023804
                btst    #$03, Obj_Subtype(A0)                            ; $0028
                beq.s   Offset_0x0237AA
                subq.w  #$01, D1
                bcs.s   Offset_0x023804
Offset_0x0237AA:
                bsr     Jmp_06_To_SingleObjectLoad             ; Offset_0x0238EA
                bne.s   Offset_0x023804
...
Offset_0x023812:
                ...
                addq.w  #$01, D3
                move.w  (A7)+, D4
                bsr     Jmp_0E_To_SolidObject                  ; Offset_0x0238FC
                bra     Offset_0x023882
Offset_0x023830:
...
Offset_0x023852:
                ...
                move.b  (A2)+, D4
                lsl.w   #$06, D4
                addi.l  #Obj_Memory_Address, D4                      ; $FFFFB000
                move.l  D4, A1
                moveq   #$00, D4
...
Offset_0x023882:
                ...
                cmpi.w  #$0280, D0
                bhi     Offset_0x02389A
                bra     Jmp_0F_To_DisplaySprite                ; Offset_0x0238E4
Offset_0x02389A:
                moveq   #$00, D2
                lea     Obj_Player_Flip_Flag(A0), A2                     ; $0029
                move.b  (A2)+, D2
Offset_0x0238A2:
                ...
                move.l  D0, A1
                bsr     Jmp_00_To_DeleteObject_A1              ; Offset_0x0238F0
                dbra    D2, Offset_0x0238A2
                rts            
;-------------------------------------------------------------------------------   
Offset_0x0238BA:
                move.w  #$0008, D1
                ...
                bra     Jmp_0F_To_DisplaySprite                ; Offset_0x0238E4 
;-------------------------------------------------------------------------------   
Rotating_Rings_Mappings:                                       ; Offset_0x0238D8
                dc.w    Offset_0x0238DA-Rotating_Rings_Mappings
Offset_0x0238DA:
                dc.w    $0001
