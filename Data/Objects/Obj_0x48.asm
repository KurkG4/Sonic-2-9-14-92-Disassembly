...
; Offset_0x01FC7C:
                ...
                move.w  Offset_0x01FC9A(PC, D0), D1
                jsr     Offset_0x01FC9A(PC, D1)
                move.b  Obj_Control_Var_00(A0), D0                       ; $002C
                add.b   Obj_Control_Var_0A(A0), D0                       ; $0036
                beq     Jmp_0C_To_MarkObjGone                  ; Offset_0x02008E
                bra     Jmp_08_To_DisplaySprite                ; Offset_0x020088    
;------------------------------------------------------------------------------- 
Offset_0x01FC9A:
                dc.w    Offset_0x01FCAE-Offset_0x01FC9A
                dc.w    Offset_0x01FCFE-Offset_0x01FC9A       
;------------------------------------------------------------------------------- 
Offset_0x01FC9E:
...
Offset_0x01FCAE:
                ...
                move.l  #Cannon_Mappings, Obj_Map(A0)   ; Offset_0x01FF08, $0004
                move.w  #$6368, Obj_Art_VRAM(A0)                         ; $0002
                bsr     Jmp_0F_To_ModifySpriteAttr_2P          ; Offset_0x020094
                move.b  Obj_Subtype(A0), D0                              ; $0028
                andi.w  #$000F, D0
                btst    #$00, Obj_Status(A0)                             ; $0022
                beq.s   Offset_0x01FCD6
                addq.w  #$04, D0
Offset_0x01FCD6:
                add.w   D0, D0
                move.b  Offset_0x01FC9E(PC, D0), Obj_Flags(A0)           ; $0001
                move.b  Offset_0x01FC9E+$01(PC, D0), Obj_Control_Var_13(A0)  ; $003F
                beq.s   Offset_0x01FCEC
...
Offset_0x01FD14:
                moveq   #$00, D0
                move.b  (A4), D0
                move.w  Offset_0x01FD20(PC, D0), D0
                jmp     Offset_0x01FD20(PC, D0)       
;-------------------------------------------------------------------------------    
Offset_0x01FD20:
                dc.w    Offset_0x01FD28-Offset_0x01FD20
                dc.w    Offset_0x01FDEE-Offset_0x01FD20
                dc.w    Offset_0x01FE9C-Offset_0x01FD20
                dc.w    Offset_0x01FEFC-Offset_0x01FD20    
;-------------------------------------------------------------------------------
Offset_0x01FD28:
...
Offset_0x01FDEE:
                ...
                bne.s   Offset_0x01FE16
                cmpi.b  #$07, Obj_Map_Id(A0)                             ; $001A
                beq.s   Offset_0x01FE30
                subq.w  #$01, Obj_Ani_Time(A0)                           ; $001E
                bpl.s   Offset_0x01FE14
...
Offset_0x01FE30:
                ...
                addq.b  #$01, D0
                btst    #$00, Obj_Status(A0)                             ; $0022
                beq.s   Offset_0x01FE42
                subq.b  #$02, D0
Offset_0x01FE42:
                andi.w  #$0003, D0
                add.w   D0, D0
                add.w   D0, D0
                move.w  Offset_0x01FE8C(PC, D0), Obj_Speed(A1)           ; $0010
                move.w  Offset_0x01FE8C+$02(PC, D0), Obj_Speed_Y(A1)         ; $0012
                move.w  #$0003, Obj_Ani_Time(A0)                         ; $001E
                tst.b   Obj_Subtype(A0)                                  ; $0028
                bpl.s   Offset_0x01FE8A
...
Offset_0x01FEFC:
                ...
                bpl.s   Offset_0x01FF06
                move.b  #$00, (A4)
Offset_0x01FF06:
                rts   
;-------------------------------------------------------------------------------  
Cannon_Mappings:                                               ; Offset_0x01FF08
                dc.w    Offset_0x01FF18-Cannon_Mappings
                dc.w    Offset_0x01FF5A-Cannon_Mappings
                dc.w    Offset_0x01FF8C-Cannon_Mappings
                dc.w    Offset_0x01FFAE-Cannon_Mappings
                dc.w    Offset_0x01FFD0-Cannon_Mappings
                dc.w    Offset_0x01FFF2-Cannon_Mappings
                dc.w    Offset_0x020014-Cannon_Mappings
                dc.w    Offset_0x020046-Cannon_Mappings
Offset_0x01FF18:
                dc.w    $0008
