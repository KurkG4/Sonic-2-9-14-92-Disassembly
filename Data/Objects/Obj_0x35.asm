...
; Offset_0x0184BC:
                ...
                move.w  Offset_0x0184CA(PC, D0), D1
                jmp     Offset_0x0184CA(PC, D1)   
;-------------------------------------------------------------------------------    
Offset_0x0184CA:
                dc.w    Offset_0x0184CE-Offset_0x0184CA
                dc.w    Offset_0x0184FC-Offset_0x0184CA
;-------------------------------------------------------------------------------    
Offset_0x0184CE:
                addq.b  #$02, Obj_Sub_Y(A0)                              ; $000A
                move.l  #Invicibility_Stars_Mappings, Obj_Map(A0) ; Offset_0x018AA2, $0004
...
Offset_0x018542:
                ...
                subq.w  #$08, D1
                andi.w  #$0010, D1
                bne.s   Offset_0x01855C
                eori.b  #$01, D6
Offset_0x01855C:
                move.b  ($FFFFFE05).w, D0
                andi.b  #$01, D0
                lea     (Offset_0x01864A), A3
                beq.s   Offset_0x018574
                lea     (Offset_0x0187B2), A3
                addq.w  #$02, A2
Offset_0x018574:
...
Offset_0x0185C4:
                ...
                addq.b  #$06, D0
                cmpi.b  #$A2, D0
                bcs.s   Offset_0x0185F0
                moveq   #$00, D0
Offset_0x0185F0:
                move.b  D0, Obj_Map(A0)                                  ; $0004
                lea     (Offset_0x01891A), A3
                lea     $00(A3, D0), A3
                moveq   #$01, D1
Offset_0x018600:
                move.b  (A3)+, D0
