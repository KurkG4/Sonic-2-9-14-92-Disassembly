...
; Offset_0x01F838:
                ...
                move.w  Offset_0x01F846(PC, D0), D1
                jmp     Offset_0x01F846(PC, D1)     
;-------------------------------------------------------------------------------   
Offset_0x01F846:
                dc.w    Offset_0x01F84E-Offset_0x01F846
                dc.w    Offset_0x01F88E-Offset_0x01F846
                dc.w    Offset_0x01F9A4-Offset_0x01F846
                dc.w    Offset_0x01F9BA-Offset_0x01F846    
;------------------------------------------------------------------------------- 
Offset_0x01F84E:
                addq.b  #$02, Obj_Routine(A0)                            ; $0024
                move.l  #Break_Boost_Mappings, Obj_Map(A0) ; Offset_0x01FAF4, $0004
                move.w  #$6332, Obj_Art_VRAM(A0)                         ; $0002
                tst.b   Obj_Subtype(A0)                                  ; $0028
                beq.s   Offset_0x01F872
                move.w  #$63FF, Obj_Art_VRAM(A0)                         ; $0002
                move.b  #$02, Obj_Map_Id(A0)                             ; $001A
Offset_0x01F872:
                bsr     Jmp_0E_To_ModifySpriteAttr_2P          ; Offset_0x01FC62
...
Offset_0x01F88E:
                ...
                bsr     Jmp_04_To_SolidObject                  ; Offset_0x01FC6E
                move.b  Obj_Status(A0), D0                               ; $0022
                andi.b  #$18, D0
                bne.s   Offset_0x01F8C8
Offset_0x01F8C4:
                bra     Jmp_0B_To_MarkObjGone                  ; Offset_0x01FC50
Offset_0x01F8C8:
                cmpi.b  #$18, D0
                bne.s   Offset_0x01F8FE
                cmpi.b  #$02, Obj_Control_Var_06(A0)                     ; $0032
                beq.s   Offset_0x01F8DE
                cmpi.b  #$02, Obj_Control_Var_07(A0)                     ; $0033
                bne.s   Offset_0x01F8C4
Offset_0x01F8DE:
                lea     (Obj_Memory_Address).w, A1                   ; $FFFFB000
                move.b  Obj_Control_Var_06(A0), D0                       ; $0032
                move.w  Obj_Control_Var_08(A0), D1                       ; $0034
                bsr.s   Offset_0x01F91A
...
Offset_0x01F8FE:
                move.b  D0, D1
                andi.b  #$08, D1
                beq.s   Offset_0x01F950
                cmpi.b  #$02, Obj_Control_Var_06(A0)                     ; $0032
                bne.s   Offset_0x01F8C4
                lea     (Obj_Memory_Address).w, A1                   ; $FFFFB000
                move.w  Obj_Control_Var_08(A0), D1                       ; $0034
                bsr.s   Offset_0x01F920
                bra.s   Offset_0x01F96C
Offset_0x01F91A:
                cmpi.b  #$02, D0
                bne.s   Offset_0x01F93C
Offset_0x01F920:
...
Offset_0x01F96C:
                ...
                bsr     Jmp_06_To_SingleObjectLoad_2           ; Offset_0x01FC56
...
Offset_0x01F97E:
                ...
                addq.w  #$04, D0
                dbra    D1, Offset_0x01F97E
                move.b  #$06, Obj_Routine(A1)                            ; $0024
Offset_0x01F990:
                lea     (Break_Boost_Data), A4                 ; Offset_0x01FAB4
                addq.b  #$01, Obj_Map_Id(A0)                             ; $001A
                moveq   #$0F, D1
                move.w  #$0018, D2
                bsr     Jmp_01_To_Smash_Object                 ; Offset_0x01FC68     
;------------------------------------------------------------------------------- 
Offset_0x01F9A4:
                bsr     Jmp_08_To_SpeedToPos                   ; Offset_0x01FC74
                addi.w  #$0018, Obj_Speed_Y(A0)                          ; $0012
                tst.b   Obj_Flags(A0)                                    ; $0001
                bpl     Jmp_0B_To_DeleteObject                 ; Offset_0x01FC4A
                bra     Jmp_07_To_DisplaySprite                ; Offset_0x01FC44 
;------------------------------------------------------------------------------- 
Offset_0x01F9BA:
                lea     (Obj_Memory_Address).w, A1                   ; $FFFFB000
                lea     Obj_Control_Var_00(A0), A4                       ; $002C
                bsr.s   Offset_0x01F9DC
                lea     (Obj_Memory_Address+$0040).w, A1             ; $FFFFB040
                lea     Obj_Control_Var_0A(A0), A4                       ; $0036
                bsr.s   Offset_0x01F9DC
                move.b  Obj_Control_Var_00(A0), D0                       ; $002C
                add.b   Obj_Control_Var_0A(A0), D0                       ; $0036
                beq     Jmp_04_To_MarkObjGone_3                ; Offset_0x01FC5C
                rts
Offset_0x01F9DC:
                moveq   #$00, D0
                move.b  (A4), D0
                move.w  Offset_0x01F9E8(PC, D0), D0
                jmp     Offset_0x01F9E8(PC, D0)       
;-------------------------------------------------------------------------------    
Offset_0x01F9E8:
                dc.w    Offset_0x01F9EC-Offset_0x01F9E8
                dc.w    Offset_0x01FA8E-Offset_0x01F9E8       
;-------------------------------------------------------------------------------    
Offset_0x01F9EC:
...
Offset_0x01FA8E:
                ...
                rts   
;-------------------------------------------------------------------------------
Break_Boost_Data:                                              ; Offset_0x01FAB4
...
;-------------------------------------------------------------------------------  
Break_Boost_Mappings:                                          ; Offset_0x01FAF4
                dc.w    Offset_0x01FAFC-Break_Boost_Mappings
                dc.w    Offset_0x01FB1E-Break_Boost_Mappings
                dc.w    Offset_0x01FBA0-Break_Boost_Mappings
                dc.w    Offset_0x01FBC2-Break_Boost_Mappings
Offset_0x01FAFC:
                dc.w    $0004
